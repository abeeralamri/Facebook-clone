...
class GroupPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_post" do
    assert_difference("GroupPost.count") do
      post group_posts_url, params: { group_post: { content: @group_post.content, group_id: @group_post.group_id, user_id: @group_post.user_id } }
    end
  ...
  test "should update group_post" do
    patch group_post_url(@group_post), params: { group_post: { content: @group_post.content, group_id: @group_post.group_id, user_id: @group_post.user_id } }
